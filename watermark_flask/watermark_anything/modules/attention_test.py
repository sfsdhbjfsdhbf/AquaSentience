...
# class ConvSlildAttention(nn.Module):
#     '''
#     Longformer attention + conv attention
#     '''
...
#
#
#         dots = sliding_chunks_no_overlap_matmul_qk(q, k, 8, 0)* self.scale
#
#         attn = dots.softmax(dim=-1)
#
#         out = sliding_chunks_no_overlap_matmul_pv(attn, v, 8)
